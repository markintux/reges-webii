    ...
    <div class="col-12 col-md-8 col-lg-10 mx-auto">
        <div class="card p-4 shadow-sm">
            ...
            <form action="{{ route('reminders.store') }}" method="POST">
                ...
                <div class="form-floating mb-3">
                    <textarea class="form-control" id="description" name="description" placeholder="Digite a descrição" style="height:100px;">{{ old('description') }}</textarea>
                ...
                @enderror
                <div class="form-floating mb-3">
                    <input type="datetime-local" class="form-control" id="remind_at" name="remind_at" value="{{ old('remind_at') }}">
